...
function ProductDetailsSkeleton() {
  return (
    <div className="product-details-page">
      <div className="details-container skeleton-details">

        {/* LEFT IMAGE */}
        <div className="details-left">
          <div className="main-image skeleton shimmer"></div>
        ...
        <div className="details-right">
          ...
          <div className="rating skeleton shimmer"></div>
          <div className="price skeleton shimmer"></div>
          <div className="type skeleton shimmer"></div>

          <div className="para skeleton shimmer"></div>
          <div className="para skeleton shimmer"></div>
          <div className="para small skeleton shimmer"></div>

          <div className="status skeleton shimmer"></div>
...
function getThumbnailsByType(type, mainImage) {
  switch (type) {
    case "hand-made bricks":
      return [mainImage,"/products/handmade1.jpg","/products/handmade2.jpg","/products/handmade3.jpg"];
    case "wire-cut bricks":
      return [mainImage,"/products/wirecut-1.jpg","/products/wirecut-2.jpg","/products/wirecut-3.jpg"];
    case "machine-cut bricks":
      return [mainImage,"/products/machine-1.jpg","/products/machine-2.jpg","/products/machine-3.jpg"];
    case "cement bricks":
      return [mainImage,"/products/cement-1.jpg","/products/cement-2.jpg","/products/cement-3.jpg"];
    default:
      return [mainImage,"/products/sample-1.jpg","/products/sample-2.jpg","/products/sample-3.jpg"];
  }
}
      ...
      <div className="details-container">
        ...
        <div className="details-left">
          ...
          >
            ...
            >
              <svg className={`heart-icon ${isWishlisted(product._id) ? "filled" : ""}`} viewBox="0 0 24 24">
          ...
          <div className="thumb-row">
            {thumbnails.map((img, i) => (
              <img key={i} src={img} onClick={() => setActiveImage(img)} className={activeImage === img ? "active" : ""}/>
            ))}
          </div>
        </div>
