...
function SkeletonCard() {
  return (
    <div className="shop-card skeleton-card">
      ...
      {/* <div className="wishlist-btn skeleton-circle shimmer"></div> */}

      <div className="product-image skeleton-rect shimmer"></div>
  ...
  return (
    <div className="shop-card">
      ...
      <button className="wishlist-btn" onClick={handleWishlist}>
        <svg className={`heart-icon ${liked ? "filled" : ""}`} viewBox="0 0 24 24">
          <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5
                   2 6 4 4 6.5 4c1.74 0 3.41 1.01 4.22 2.09
                   C11.09 5.01 12.76 4 14.5 4
                   17 4 19 6 19 8.5
      ...
      <div className="shop-card-body">
        ...
        <div className="action-row">
          <button className="add-cart-btn" disabled={product.status !== "in-stock"} onClick={handleAddToCart}>
            Add to Cart
          </button>

          <button className="buy-btn" disabled={product.status !== "in-stock"} onClick={handleBuyNow}>
            Buy Now
          </button>
        </div>
      </div>
